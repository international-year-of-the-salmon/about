...
* **Supply data as plain text files:** (eg .csv, .txt) or common formats such as Microsoft Excel (.xlsx). Avoid formats that require special software. Use the [IYS Data Template](https://docs.google.com/spreadsheets/d/1bRWwUktLyE9LrqAkqRWp57k0OXtlVLa7/edit?usp=sharing&ouid=115784895965147788100&rtpof=true&sd=true) for catch/specimen data, CTD, and Rosette data. See the [example data package data file](https://github.com/international-year-of-the-salmon/about/tree/main/example_data_package/data.xlsk) for other data types.
...
See an [example data package to copy here](https://github.com/international-year-of-the-salmon/about/tree/main/example_data_package)
